...
**Usage**: 
```
python3 geoserver.py -g "http://localhost:8080/geoserver/rest" -u admin -p geoserver -c geo-data -cs "azure_connection_string" -sas "azure_sas_token" -d "Group-D/VIZAG/Cycle_01/GKONDURU-IP2" -P
```
...
# Naming conventions
An example of the naming convention followed, is explained below with the help of a sample GeoTiff blob: `Group-C/JHBDPL/Cycle_01/10260001_S_Name/K.CHERUVU-GVK_Orthomosaic_19_COG.tif`
